<?php
/**
 * Starter Theme Options Sanitization Functions
 *
 * @package Starter
 */
 ...
 */
function starter_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function starter_sanitize_post( $input ) {
 ...
 */
function starter_sanitize_image( $image, $setting ) {
    /*
 ...
 * @since Starter 0.1
 */
function starter_sanitize_category_list( $input ) {
    if ( '' != $input ) {
        if( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 *                    the setting default.
 */
function starter_sanitize_number_range( $number, $setting ) {
