...
<?php
$enable_content = get_theme_mod( 'starter_featured_content_option', 'disabled' );

if ( ! starter_check_section( $enable_content ) ) {
	// Bail if featured content is disabled.
	return;
}
	$featured_posts = starter_get_featured_posts();
	...
	$title     = get_option( 'featured_content_title', esc_html__( 'Contents', 'starter' ) );
