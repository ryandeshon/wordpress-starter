		...
		<h2 class="comments-title">
			<?php
				...
				if ( '1' === $comments_number ) {
					printf(
						/* translators: %s: title. */
						esc_html_x( 'One Reply to &ldquo;%s&rdquo;', 'comments title', 'starter' ),
						get_the_title()
					);
				} else {
					printf( // WPCS: XSS OK.
						/* translators: 1: comment count number, 2: title. */
						esc_html( _nx( '%1$s Reply to &ldquo;%2$s&rdquo;', '%1$s Replies to &ldquo;%2$s&rdquo;', $comments_number, 'comments title', 'starter' ) ),
